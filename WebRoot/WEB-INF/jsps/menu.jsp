...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            系统管理
                <ul>
                    <li class="menu-item"><a href="${path }/dept_list.action" target="main-frame">部门管理</a></li>
                    <li class="menu-item"><a href="${path }/emp_list.action" target="main-frame">员工管理</a></li>
                </ul>
            </li>
           ...
           业务模块
                <ul>
                    <li class="menu-item"><a href="${path }/customer_list.action?condition.traceStatus=0" target="main-frame">客户资料管理</a></li>
                    <li class="menu-item"><a href="${path }/trace_list.action" target="main-frame">客户跟进记录</a></li>
                    <li class="menu-item"><a href="${path }/transfer_list.action" target="main-frame">客户移交历史</a></li>
                    <li class="menu-item"><a href="${path }/customer_list.action?condition.traceStatus=-1" target="main-frame">客户资源池</a></li>
                </ul>
            </li>
        </ul>
    </div>
